...
import { X, Calendar, Clock, MapPin, Users, Award, CheckCircle2, TicketCheck, Sparkles, Share2 } from 'lucide-react';
            ...
            <div className="p-4 rounded-2xl bg-slate-950/80 border border-slate-800 flex items-center justify-between">
              ...
              {!isHoliday && (
                <button
                  ...
                  className={`px-5 py-2.5 rounded-xl font-extrabold text-xs tracking-wider uppercase cursor-pointer shadow-lg transition-all active:scale-95 flex items-center gap-2 ${
                    isRegistered 
